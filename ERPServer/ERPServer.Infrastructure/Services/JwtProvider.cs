...
{
    public class JwtProvider(UserManager<AppUser> userManager, IOptions<JwtOption> jwtOptions) : IJwtProvider

    {
        public async Task<LoginCommandResponse> CreateToken(AppUser user)
        {
            List<Claim> claims = new()
          {
            ...
            return new(token, refreshToken, refreshTokenExpires.ToString());
        }
